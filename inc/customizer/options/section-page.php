...
function legalblow_customizer_page_register( $wp_customize ) {
	...
	// Title label
	$wp_customize->add_setting( 
		'legalblow_label_page_sidebar_settings', 
		array(
		    'sanitize_callback' => 'legalblow_sanitize_title',
		) 
	);
	...
	$wp_customize->add_control( 
		new LegalBlow_Title_Info_Control( $wp_customize, 'legalblow_label_page_sidebar_settings', 
		array(
		    'label'       => esc_html__( 'Page Sidebar', 'legalblow' ),
		    'section'     => 'legalblow_page_settings',
		    'type'        => 'legalblow-title',
		    'settings'    => 'legalblow_label_page_sidebar_settings',
		) 
	));

	// Add an option to enable the page sidebar
	$wp_customize->add_setting( 
		'legalblow_enable_page_sidebar', 
		array(
		    'default'           => false,
		    'type'              => 'theme_mod',
		    'sanitize_callback' => 'legalblow_sanitize_checkbox',
	...
	$wp_customize->add_control( 
		new LegalBlow_Toggle_Control( $wp_customize, 'legalblow_enable_page_sidebar', 
		array(
		    'label'       => esc_html__( 'Show Sidebar', 'legalblow' ),
		    'section'     => 'legalblow_page_settings',
		    'type'        => 'legalblow-toggle',
		    'settings'    => 'legalblow_enable_page_sidebar',
		) 
	));

	// Sidebar layout
    $wp_customize->add_setting(
        'legalblow_page_sidebar_layout',
        array(
            'default'			=> 'no',
            'type'				=> 'theme_mod',
            'capability'		=> 'edit_theme_options',
    ...
    $wp_customize->add_control(
        new LegalBlow_Radio_Image_Control( $wp_customize,'legalblow_page_sidebar_layout',
            array(
                'settings'		=> 'legalblow_page_sidebar_layout',
                'section'		=> 'legalblow_page_settings',
                ...
                'active_callback' => 'legalblow_page_sidebar_enable',
            )
        )
    );
