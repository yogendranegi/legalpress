...
// Exit if LegalBlow_Radio_Image_Control exists and WP_Customize_Control does not exsist.
if ( class_exists('LegalBlow_Radio_Image_Control') && ! class_exists( 'WP_Customize_Control' ) ) :
	return null;
endif;
 ...
 * @access public
 */
class LegalBlow_Radio_Image_Control extends WP_Customize_Control {
	 ...
	 * @var string
	 */
	public $type = 'legalblow-radio-image';
